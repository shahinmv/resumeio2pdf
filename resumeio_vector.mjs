...
.sec{display:grid;grid-template-columns:23% 77%;column-gap:14px;border-top:1px solid #dcdcdc;padding-top:9px;margin-top:9px}
...
.head{display:flex;justify-content:space-between;align-items:baseline;gap:10px}.title{font-weight:700;font-size:14px;color:#1a1a1a}
.place{font-size:11px;color:#555;white-space:nowrap}.body{margin-top:3px}.body ul{padding-left:15px;margin:2px 0}.body li{margin:2px 0;padding-left:2px}.body p{margin:2px 0}
